                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-lg-10">
                            <header class="d-sm-flex align-items-center border-bottom mb-4 pb-3">
                                ...
                                <div class="ms-auto">
                                    <select class="form-select d-inline-block w-auto border pt-1" autocomplete="off" onchange="window.location.href='${pageContext.request.contextPath}/products?categoryId=' + this.value;">
                                        ...
                                        <option <% if (category.getId() == selectedId) out.print("selected=\"selected\""); %> value="<%=category.getId()%>"><%=category.getName()%></option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 d-flex">
                                    <div class="card w-100 my-2 shadow-2-strong">
                                        <img src="<%= request.getContextPath() +"/img/user-images/" + product.getProductImagePath()%>" class="card-img-top"/>
                                        <div class="card-body d-flex flex-column">
                                            <div class="d-flex flex-row">

                                                <h5 class="mb-1 me-1">$<%=product.getProductPrice()%></h5>

<%--                                                <%if(product.getOriginalPrice != null){  %>--%>
<%--                                                <span class="text-danger"><s><%=product.getOriginalPrice()%></s></span>--%>
<%--                                                <%}%>--%>
                                            </div>
